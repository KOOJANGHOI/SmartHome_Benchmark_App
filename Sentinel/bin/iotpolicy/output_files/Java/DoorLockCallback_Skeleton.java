...
public class DoorLockCallback_Skeleton implements DoorLockCallback {

	private DoorLockCallback mainObj;
	...
	public DoorLockCallback_Skeleton(DoorLockCallback _mainObj, int _portSend, int _portRecv) throws Exception {
		mainObj = _mainObj;
	...
	public DoorLockCallback_Skeleton(DoorLockCallback _mainObj, IoTRMIComm _rmiComm, int _objectId) throws Exception {
		mainObj = _mainObj;
		rmiComm = _rmiComm;
		objectId = _objectId;
		set2Allowed = new ArrayList<Integer>(Arrays.asList(object2Permission));
